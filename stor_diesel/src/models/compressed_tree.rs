//! Author: pacman82
//! https://github.com/pacman82/contigious-tree/blob/103b071fd5d608235838a11bbd9b1f089e92c985/src/lib.rs
...
impl Node for Comp64 {
    ...
    fn read_value(bytes: &[u8]) -> (usize, Self::Value) {
        const SIZE: usize = u8::BITS
        let total_len = bytes.len();
        let last_four_bytes: &[u8; 4] = bytes[(total_len - 4)..].try_into().unwrap();
        (4, Self::Value::from_ne_bytes(*last_four_bytes))
    }
}
